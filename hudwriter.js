// HUD text writer
function hudwrite(ctx, x, y, text, size, style)
{
  ctx.save();
...
function hudshadowwrite(ctx, x, y, text, size, style)
{
  hudwrite(ctx, x+(size/2), y+(size/2), text, size, "rgba(64,64,64,0.5)");
  hudwrite(ctx, x, y, text, size, style);
}
